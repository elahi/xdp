...
### Writing up your answers in R markdown 

Read the following websites:

https://rmarkdown.rstudio.com/articles_intro.html

You should practice knitting an html file. For more details, see:

https://r4ds.had.co.nz/r-markdown.html

Once you start feeling comfortable, create a new .Rmd file that answers the above questions about the present day birth records in the U.S. Include both text (the questions, and your answers), as well as the R code needed to produce the answers (as well as the answers). Knit the file to an html file, and send it to Robin via email for your first lab assignment. 
