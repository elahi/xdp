...
| Week | Topics                                               |
|------|------------------------------------------------------|
| 1    | Intro to course, data, and R |
| 2    | Sampling, descriptive statistics, data viz | 
...
This course is a practical introduction to data analysis and experimental design for biologists and environmental scientists. Upon completion of the course, students will be able to:
  ...
  1. Recognize the importance of data collection, identify limitations in data collection methods, and become aware of other sources of statistical bias. 
