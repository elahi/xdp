...
**Teaching assistant**  
Nicole Moyen   
  - Office: Denny Lab (Fisher)    
  - Office hours: 12-2pm, Tuesday  
...
**Times and Rooms:**  
2:30-4pm; Mondays & Wednesdays; Fisher classroom

**Textbook**

We will use a variety of resources in this course. The primary one is:

[Open intro statistics, 3rd edition](https://www.openintro.org/stat/) - freely available as a pdf (or get a print copy for ~$15). 

The others will be online resources for learning the basics of data science using `R`.

## Schedule

| Week | Topics                                               |
|------|------------------------------------------------------|
| 1    | Intro to course, data collection, and R |
| 2    | Numerical and categorical data, data viz | 
| 3    | Intro to probability   |
| 4    | Normal distribution, intro to inference      |
| 5    | Hypothesis testing      |
| 6    | Inference for numerical data      |
| 7    | Analysis of variance      |
| 8    | Regression       |
| 9    | General linear models, multiple predictors     |
| 10   | Two-way ANOVA: blocked, nested, crossed      |
...
- Complete the readings before class, to prime you for class lessons (not to mention the quizzes). Then go over the readings again, after class. 
...
Use of your personal computer for in-class exercises, such as data analysis and literature searches, is highly recommended. Please let us know if you do not have a computer so we may make classroom arrangements.
