...
We will use a variety of resources in this course. Whenever possible, I will use freely available material online to supplement the materials I prepare. Occasionally, I will refer you to textbooks that we have on reserve in the library. 

In particular, we will use:

[Open intro statistics, 3rd edition](https://www.openintro.org/stat/)

Specific readings will be detailed on the materials page on a weekly basis. 
...
Here is a breakdown of graded tasks:
  ...
  - Pre-class quizzes on canvas (30%)
  - Exams (40%)
