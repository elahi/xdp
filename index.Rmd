...
This course is a practical introduction to data analysis and experimental design for biologists and environmental scientists. Upon completion of the course, students will be able to:
  ...
  2. assemble and prepare data in spreadsheets
  3. produce and interpret effective graphical displays of data
  4. describe the utility and limitations of null hypothesis significance testing
  5. understand the framework of general linear models and apply basic analytical tools for inference
  6. use R for data analysis and visualization
